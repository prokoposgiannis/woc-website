  ...
  return (
    <div className="w-full h-full">
      <form
        ...
        className="h-full w-full mx-auto p-4 bg-gray-100 shadow-xl rounded-xl"
      >
        <div className="mb-4">
          <label
            htmlFor="name"
        ...
        <div className="text-center">
          <button
            type="submit"
            className="font-bold text-gray-900 py-2 transition-transform duration-10 transform hover:text-sky-600"
          >
            {modalMessage}
          </button>
        </div>
