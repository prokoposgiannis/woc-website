...
export default function ForthBlockRight() {
  return (
    <div className="flex h-full px-3 mt-32 justify-center text-white bg-secondaryColor p-3 rounded-xl">
      <div
      ...
      <div className="flex flex-col w-1/2 px-7 h-full justify-center items-center bg-secondaryColor">
